...
- [Redis quick
start](https://intranet.alxswe.com/rltoken/8xeApIhnxgFZkgn54BiIeA)
- [Redis client
interface](https://intranet.alxswe.com/rltoken/1rq3ral-3C5O1t67dbGcWg)
- [Redis client for Node
JS](https://intranet.alxswe.com/rltoken/mRftfl67BrNvl-RM5JQfUA)
...
Install
[node_redis](./https://intranet.alxswe.com/rltoken/mRftfl67BrNvl-RM5JQfUA) using npm
...
- When the function is called, track the progress of the `job` of `0` out of
`100`
